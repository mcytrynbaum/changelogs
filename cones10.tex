...
Our model nests a large number of previous matching models.
...
We give the algorithm but omit full descriptions of the relevant subroutines.
For intuition, in the subroutine labeled ``InformationAcquire'' we solve subproblems and collect information about problem cone collisions.
...
For the purposes of this writing sample, we may think of the input $\acto$ as an initial collection of problems of the form $\toppre - e_i$, where $\toppre$ is some maximal element.
