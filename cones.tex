...
Using cone geometry, we show how to efficiently combine this shared information to identify the full set of strict core matchings significantly more quickly. 
...
The reachable set of a vertex $w$ in a forest $\forest$ is defined as its reachable set in the unique tree (a maximal connected component) containing it, denoted by $\reach(w, \forest)$
