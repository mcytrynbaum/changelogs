...
Before giving the full algorithm, we need to discuss the initialization of subproblems. 
As in section~\
For the algorithm to find $\fix(T) \sub \prealloc$, we could 

\subsubsection{Algorithm for Finding all Stable Matchings}
