...
\emph{Stage 2 - Information combination}: In this stage, we inductively assume the existence of a \emph{problem forest}, which we define as a collection of rooted trees such that 
...
We call a forest the obeys these relations \emph{correctly constructed}. 
