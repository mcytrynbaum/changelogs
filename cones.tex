...
Fix an order on $\mathcal{J}$, which can be extended to problems $\pre$ added to $\actt$ by letting $\pre_{j_1}$ be the problem added while processing strong component $j_1$. 
Call index $j_i$ processed if $j_i$ has been already been added to 
