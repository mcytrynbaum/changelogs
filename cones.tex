...
\subsection{The Strict Core and Fixed Preallocations}
...
However, it may also pick up extra \emph{uncoordinated} matchings if any of these are fixed by $T$. Fortunately, none are
