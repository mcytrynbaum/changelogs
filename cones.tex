...
\subsection{Notation and Intuition} \label{section:description1}
...
First, we need to define some stopping conditions.
...
rewrite sections / numbering
rewrite discussion sections up to references
collate references 
