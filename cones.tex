...
In this way, we will eventually find the full set of strict core outcomes, directly extending the \cite{EcheniqueYenmez2013} algorithm to the present setting.  
...
\prf
Note that a graph $G = (V,E)$ is a tree\footnote{\cite{GrossYellen2013graphs} p.116} if and only if $G$ is connected and $|E| = |V| - 1$. 
