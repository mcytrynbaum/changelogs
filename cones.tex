...
\newcommand{\acta}{Q_A} 
\newcommand{\actan}{Q_A^{n'}} 
\newcommand{\actann}{Q_A^{n' + 1}} 
\newcommand{\actc}{Q_C} 
\newcommand{\act}{Q} 
...
Then suppose by induction that our hypothesis holds up to $\ell = n'$.
We will show that the conclusion still holds for $n' + 1$.
...
\emph{Case 1}: $\actan \to \actann$ when stopping condition (1) or (3)
