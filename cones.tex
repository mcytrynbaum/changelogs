...
Since there is a directed edge $(i,j)$ in the digraph only if $\fix(\pre_i) \sub \fix(\pre_j)$, we see that the equivalence of subproblems is reflected in the connectedness of the graph. 

Consider now a hypothetical subproblem 
